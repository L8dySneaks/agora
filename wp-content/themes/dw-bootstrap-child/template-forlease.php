...
<div class="agora-forlease">
  <div class="row">
    <div class="col-md-12">
      <p class="text-uppercase header-title white">For Lease</p>
    </div>
  </div>
</div>
  ...
  <div class="row row-eq-height">
    <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 red-bg">
      <div class="left-content">
        <p>SHOULD YOU HAVE ANY QUESTIONS ABOUT OUR PROPERTIES THAT ARE FOR LEASE, PLEASE CONTACT US AT 818-985-7100.</p>
      </div>
    </div>
