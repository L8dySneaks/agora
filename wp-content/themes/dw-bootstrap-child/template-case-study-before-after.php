<?php
/*
* Template Name: Case Study Before/After Template
*/
?>
<?php get_header(); ?>
...
<div class="agora-case-study-before-after">
  <div class="container-fluid">
    <div class="row">
      <div class="col-xs-12 col-sm-6 col-md-6 no-padding">
        <div class="case-study-before">
          <p class="text-uppercase caption-white">Before</p>
        </div>
      </div>
      <div class="col-xs-12 col-sm-6 col-md-6 no-padding">
        <div class="case-study-after">
          <p class="text-uppercase caption-white">After</p>
        </div>
      </div>
    </div>
  </div>
...
<div id="agora-case-study-before-after" class="container-fluid">
